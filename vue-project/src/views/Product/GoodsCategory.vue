<template>
  ...
  <el-table :data="list" style="width: 100%">
    ...
    <el-table-column align="center" label="样例" #default="scope">
      <el-image :src="scope.row.sample" style="width: 100px; height: 100px">
      </el-image>
    </el-table-column>
  ...
  <el-dialog title="添加商品种类" v-model="addShow" width="40%">
    <el-form :model="typeInfo" label-width="80px">
      ...
      <el-form-item>
        <el-button type="primary" @click="AdddGoodsType">确定</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
  <!-- 编辑弹框 -->
...
export default {
  ...
  methods: {
    ...
    edit(row) {
      this.editShow = true
      this.typeInfo = row
      this.imageUrl=this.typeInfo.picture
    },
    async editGoodsType() {
      const formData = new FormData()
      formData.append('id', this.typeInfo.id)
